...
<body>
    ...
    <!-- Форма отправки данных на decoration.php -->
    <form action="decoration.php" method="post" onsubmit="return processForm(event)">
        ...
        <label for="owner-name">Фамилия и имя владельца автомобиля:</label>
    ...
    <div id="insurance-details" style="display: none;">
        ...
        <p id="confirmation-message" style="display: none;">С вашими выбранными параметрами вы заплатите за страховку <span id="final-price"></span></p>
    </div>
</section>
...
<script>
    ...
    function calculatePrice() {
        ...
        document.getElementById('final-price').innerHTML = price + ' руб.';
