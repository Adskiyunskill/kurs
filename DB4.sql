...
INSERT INTO `cars` VALUES (1,'Форд Фокус',2018,1),(2,'Mercedes-Benz E240',2006,2),(3,' iveco daily',2012,11);
...
INSERT INTO `cars_addition` VALUES (1,1,'Легковой',300000.00,'Неоднократный ремонт авто.'),(2,2,'Легковой',156000.00,'Участник двух ДТП'),(3,3,'Грузовое',60000.00,'Ранне была зарегесрирована в другой компании');
...
CREATE TABLE `insurance_policies` (
  `id_Insurance_policies` int NOT NULL AUTO_INCREMENT,
  `cars_id_cars` int NOT NULL,
  ...
  PRIMARY KEY (`id_Insurance_policies`),
...
) ENGINE=InnoDB AUTO_INCREMENT=24534348 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `insurance_policies` VALUES (2,2,'Обязательный','2020-04-20','2021-05-28',7500.00,'Off'),(11,3,'Обязательный','2021-05-20','2024-05-20',6500.00,'On');
...
INSERT INTO `user` VALUES (1,'admin','admin','79621848940','agarions21@gmail.com','1','Дмитрий','Скворцов'),(2,'anna89','password2','88499390','annaexample@gmail.com','2','Анна','Форджер'),(11,'testik2','energo1302','+79642234554','gooodgamer@gmail.com','3','Андрей','Забинский'),(12,'testik3','grom417',NULL,'zabegalov@gmail.com',NULL,NULL,NULL),(16,'testik4','energo144',NULL,'godgamer@gmail.com',NULL,NULL,NULL);
...
-- Dump completed on 2023-07-03 11:43:16
